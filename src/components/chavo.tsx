...
const SECTIONS: { title: string; body: string }[] = [
  {
    title: "Стол",
    body: "Собери 2–8 человек. «Стол по сети» даёт ссылку — каждый со своего телефона, хоть из разных городов. Первый в ссылке ведёт стол. На одном телефоне — как раньше.",
  },
  {
    title: "Колода",
  ...
  },
  {
    ...
    body: "Минус снимает Suno, не браузер. Поёшь поверх минуса — в файл не кладём второй голос. Запись сохраняется wav, откроет любой плеер. «Сделать кавер» отправляет запись в Suno.",
  },
  {
    title: "Балалаечка",
  ...
  {
    title: "Круг строк",
    body: "Каждый пишет строку за 10 секунд в начале круга. На тестах хватит двоих. Не успел — минус 1 нота. Строки уходят в Suno. Когда готова — сначала послушай оригинал, потом пой в минус. Файл записи — wav.",
  },
  {
    title: "Оценки",
