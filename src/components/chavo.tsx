...
const SECTIONS: { title: string; body: string }[] = [
  {
    title: "Стол",
    body: "Собери 2–8 человек. По сети: «Стол по сети» даёт ссылку — каждый со своего телефона, хоть из другого города. На одном телефоне — как раньше. Имя нужно, фото по желанию.",
  },
  {
    title: "Колода",
    body: "Только Suno: публичная ссылка или «Сварить трек» своим текстом. За столом по сети каждый кидает своё. Чужие хиты не кладём — минус известной песни это авторское, можно влететь.",
  },
  {
    title: "Текст",
  ...
  },
  {
    ...
    body: "«Снять минус» убирает голос у Suno-трека. «Спеть и записать» пишет твой голос поверх. «Сделать кавер» отправляет запись в Suno. Всё это можно скачать до стола.",
  },
  {
    title: "Балалаечка",
  ...
  {
    title: "Круг строк",
    body: "Каждый пишет строку за 10 секунд в начале круга. Не успел — минус 1 нота. Строки уходят в Suno: сначала стихи, потом трек. Пока варится — поёте колоду. Когда готова — балалайка темнеет и сама выбирает, кто её поёт.",
  },
  {
    title: "Оценки",
