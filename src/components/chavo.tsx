...
const SECTIONS: { title: string; body: string }[] = [
  ...
  {
    title: "Круг строк",
    body: "Каждый пишет строку за 10 секунд в начале круга. На тестах хватит двоих. Не успел — минус 1 нота. Строки уходят в Suno: стихи с юмором, потом трек. Пока варится — поёте колоду. Когда готова — балалайка темнеет. Эту песню поём С голосом Suno: её ещё никто не слышал, иначе не подхватить.",
  },
  {
    title: "Оценки",
