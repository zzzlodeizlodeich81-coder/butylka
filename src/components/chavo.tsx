...
const SECTIONS: { title: string; body: string }[] = [
  ...
  {
    title: "Круг строк",
    body: "Каждый пишет строку за 10 секунд в начале круга. Не успел — минус 1 нота. Из строк варится новая песня. Пока варится — поёте колоду. Когда готова — балалайка темнеет и сама выбирает, кто её поёт.",
  },
  {
    title: "Оценки",
